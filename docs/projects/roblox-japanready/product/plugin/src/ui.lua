...
function Ui.create(pluginObject: Plugin): View
	local toolbar = pluginObject:CreateToolbar(TOOLBAR_NAME)
	...
	local widget = pluginObject:CreateDockWidgetPluginGui(WIDGET_ID, widgetInfo)
